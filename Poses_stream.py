...
def is_taichi_push(pose_landmarks ):
    ...
    if right_leg_angle > 160 and left_leg_angle < 110 and left_leg_angle > 80 and right_arm_angle > 140 and left_arm_angle > 140:
...
def is_taichi_split(pose_landmarks):
    ...
    if left_leg_angle > 155 and right_leg_angle < 130 and right_leg_angle > 80 and right_arm_angle > 140 and left_arm_angle > 60 and left_arm_angle < 100:
...
def is_taichi_ward_off(pose_landmarks):
    ...
    # Definir las condiciones para la pose del split de Tai Chi
    if left_leg_angle > 80 and left_leg_angle < 130 and right_leg_angle > 120 and right_leg_angle < 165 and left_arm_angle > 160 and right_arm_angle < 70:
        # if hands_distance > 60:
            # print("yes")
        return True
...
def is_taichi_pull_down(pose_landmarks):
    ...
    # Definir las condiciones para la pose del split de Tai Chi
    if left_leg_angle > 160 and right_leg_angle < 120 and left_arm_angle > 70 and left_arm_angle < 120 and right_arm_angle < 20:
        # if hands_distance > 60:
            # print("yes")
        return True
